...
.. dropdown:: Q: I'm getting "pixi: command not found" when trying to install. What should I do?
...
.. dropdown:: Q: What are the system requirements to run gb-dispatch-model?
...
.. dropdown:: Q: Can I run this on a laptop?
...
.. dropdown:: Q: Snakemake is failing to run. What should I do?
...
.. dropdown:: Q: How do I run the full model?
...
.. dropdown:: Q: Can I run only the data processing steps?
...
.. dropdown:: Q: Can I run specific workflow steps?
...
.. dropdown:: Q: What effect does running each future year separately have?
   ...
   From tests, recorded in `a GitHub issue <https://github.com/open-energy-transition/gb-dispatch-model/issues/218>`_, we found that pumped hydro storage creates/destroys energy equivalent to less than a day of European load.
   ...
   We would recommend using the third option, alongside a representation of the `water value <https://docs.pypsa.org/latest/examples/water-value/>`_ from annual perfect foresight runs.

Configuration & Scenarios
==========================

.. dropdown:: Q: What configuration files should I use?
...
.. dropdown:: Q: What is the FES and how do I change the FES year?
...
.. dropdown:: Q: How do I change the temporal resolution?

   You can request the application of `PyPSA time aggregation methods <https://docs.pypsa.org/latest/api/networks/cluster/#pypsa.Network.cluster.temporal>`_ using the ``time_aggregation`` configuration item.
   See ``config/config.gb.time-segment.yaml`` for an example.

.. dropdown:: Q: What does each configuration option do?

   You can find some details about each configuration option in our `documentation <https://gb-dispatch-model.readthedocs.io/en/latest/gb-model/configuration.html>`_.
...
.. dropdown:: Q: What are some of the key configuration options I might want to modify?
...
.. dropdown:: Q: Can I use my own data instead of the defaults?
...
.. dropdown:: Q: Where are the results stored?
...
.. dropdown:: Q: How do I interpret the results?
   ...
   See `the PyPSA documentation <https://docs.pypsa.org/latest/user-guide/statistics/>`_ for detailed guidance on generating appropriate statistics to interpret results.

.. dropdown:: Q: Can I export results in different formats?
   ...
   See the `PyPSA import/export documentation <https://docs.pypsa.org/latest/user-guide/import-export/>`_ for more information.

Solvers & Optimisation
======================

.. dropdown:: Q: What solvers can I use?

   The model supports and solvers that are also supported by `linopy <https://linopy.readthedocs.io/en/latest/>`_.
...
.. dropdown:: Q: The solver is running very slowly. What can I do?
...
.. dropdown:: Q: What does "infeasible" or "unbounded" mean?
...
.. dropdown:: Q: Can I run the optimisation with my own solver settings?
...
.. dropdown:: Q: I'm getting out-of-memory errors. What can I do?
...
.. dropdown:: Q: Snakemake says a rule failed. How do I debug it?
...
.. dropdown:: Q: How do I update the model code from PyPSA-Eur?
